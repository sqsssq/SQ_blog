    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#outButton").click(function () {
                ...
                $.get("http://localhost:8080/sqblog_war_exploded/addBlog", {
                    title: title,
                    info: information,
                    summary: summary
                }, function (data) {
                    window.location.href = "${pageContext.request.contextPath}/blogList";
                })
            })
    ...
    <div class="row" style="margin-left: 0px; margin-right: 0px;">
        ...
        <div class="col-sm-9" style="padding-left: 0px; margin-top: 10px; padding-right: 20px;">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="博文名称" aria-label="Recipient's username"
                       aria-describedby="button-addon2" id="title">
                <input type="text" class="form-control" placeholder="标签" aria-label="Recipient's username"
